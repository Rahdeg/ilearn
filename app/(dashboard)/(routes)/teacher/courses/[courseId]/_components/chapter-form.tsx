                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className=" space-y-4 mt-4">
                            <FormField control={form.control} name="title"
                                render={({ field }) => (
                                    <FormItem>
                                        <FormControl>
                                            <Input disabled={isSubmitting} placeholder="e,g 'Intoduction" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <Button className="" disabled={!isValid || isSubmitting} type="submit"> Create</Button>
            ...
            }
            {
                !isCreating && (
                    <div className={cn(" text-sm mt-2", !initialData.chapters.length && " text-slate-500 italic")}>
                        ...
                        <ChapterList items={initialData.chapters || []} onEdit={onEdit} onReorder={onReoder} />
                    </div>
                )
            }
            {
